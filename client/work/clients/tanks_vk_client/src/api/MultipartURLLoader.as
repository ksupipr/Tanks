package api
{
        ...
        import api.MultipartURLLoaderEvent;
        ...
        public class  MultipartURLLoader extends EventDispatcher
        {
                ...
                private function doSend():void
                {
                        ...
                        addListener();
												...
												trace("method="+urlRequest.method);
												trace("data="+urlRequest.data);
												var h_str:String="";
												for(var i:int=0;i<urlRequest.requestHeaders.length;i++){
													h_str+=urlRequest.requestHeaders[i].name+"="+urlRequest.requestHeaders[i].value;
												}
												trace("requestHeaders="+h_str);
												client.sendReq(urlRequest);*/
